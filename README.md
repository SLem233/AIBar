...
последних данных), `http_status` провайдеров, индикацию паузы и сворачивание
виджета у края экрана в UI (offscreen-Qt), а также агрегацию статистики AgentPulse — эти тесты
